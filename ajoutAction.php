...
// Initialize message variable
  ...
  if (isset($_POST['upload'])) {
	...
	$title_event = mysqli_real_escape_string($conn, $_POST['title_event']);
  	$text_event = mysqli_real_escape_string($conn, $_POST['text_event']);
  	

  	// image file directory
  	$target = "images/".basename($image_event);

  	$sql = "INSERT INTO evenement (title_event,text_event,image_event) VALUES ('$title_event', '$text_event','$image_event')";
  	// execute query
  	mysqli_query($conn, $sql);

  	if (move_uploaded_file($_FILES['image_event']['tmp_name'], $target)) {
...
/*
			...
			*/
			?>
			 ...
			 <form method="post" action="ajoutAction.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
					
					
				   <div class="control-group">
						 <label class="control-label" for="basicinput">Titre</label>
					
						<input class="uk-input" class="span8" type="text"  name="title_event"  id="basicinput">
					</div>
					 <div class="control-group">
					 ...
					 <input type="hidden" name="size" value="1000000" class="uk-input" class="span8">
						...
						<label class="control-label" for="basicinput">Image</label>
						  <input type="file" name="image_event" class="uk-input" class="span8">
						</div>
						<div class="control-group">
