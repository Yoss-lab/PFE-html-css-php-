...
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			$query3=mysqli_query($conn,"UPDATE user SET pseudo = '$pseudo',prenom = '$prenom', phone = '$phone', adresse = '$adresse', code_post = '$code_post', ville = '$ville', password = '$password' WHERE id = '$id'");
			if($query3)
			{
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						...
						<input class="uk-input" type="text" placeholder="Nom" name="pseudo"  id="basicinput"class="span8" 
						value="<?php echo $query2['pseudo']; ?>">
					</div>
					
					 <div class="control-group">
						 <label class="control-label" for="basicinput">Prenom</label>
						<input class="uk-input" type="text" placeholder="Prenom" name="prenom"  id="basicinput"class="span8"
						value="<?php echo $query2['prenom']; ?>">
					</div>
					
					 <div class="control-group">
						 <label class="control-label" for="basicinput">Teléphone</label>
						<input class="uk-input" type="text" placeholder="Phone Number" name="phone"  id="basicinput"class="span8"
						value="<?php echo $query2['phone']; ?>">
					</div>
					
					<div class="control-group">
						 <label class="control-label" for="basicinput">Adresse</label>
						<input class="uk-input" type="text" placeholder="Adresse" name="adresse"  id="basicinput"class="span8" 
						value="<?php echo $query2['adresse']; ?>">
					</div>
					
					<div class="control-group">
						 <label class="control-label" for="basicinput">Code postale</label>
						<input class="uk-input" type="text" placeholder="Code postale" name="code_post"  id="basicinput"class="span8">
					</div>
					
					
					 <div class="control-group">
					 <label class="control-label" for="basicinput">Ville</label>
					    <input class="uk-input" type="text" placeholder="Ville" name="ville"  id="basicinput"class="span8"
						value="<?php echo $query2['ville']; ?>">
				   ...
				   <div class="control-group">
						...
						<input class="uk-input" type="text" placeholder="Email" name="email"  id="basicinput"class="span8"
						value="<?php echo $query2['email']; ?>">
					</div>
				 
					  <div class="control-group">
						 <label class="control-label" for="basicinput">Password</label>
						 
						<input class="uk-input" type="text" placeholder="Password" name="password"  id="basicinput"class="span8"
						value="<?php echo $query2['password']; ?>">
					</div>
