	...
	<div class="wrapper">
		<div class="container">
			...
			if(isset($_POST['submit']))
			{
				...
				$image_stage = $_POST['image_stage'];
				

			$query3=mysqli_query($conn,"UPDATE stage SET title_stage = '$title_stage',desc_stage = '$desc_stage',annonce_de = '$annonce_de' WHERE id_stage = '$id'");
			if($query3)
			{
			...
			$query1=mysqli_query($conn,"select * from stage where id_stage='$id'");
			...
			?>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Modidfier l'offre de stage</h3>
							</div>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						...
						<input class="uk-input" type="text"  name="title_stage"  id="basicinput"class="span8" 
						value="<?php echo $query2['title_stage']; ?>">
					</div>
					...
					<!--<div class="control-group">
					 ...
					 <div class="control-group">
						 ...
						 <textarea class="uk-input" type="text"  name="desc_stage"  id="basicinput"class="span8">
								<?php echo $query2['desc_stage']; ?>
						</textarea>
					</div>
