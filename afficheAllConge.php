                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">-->
									   ...
									   <?php
												...
												echo "<table class='uk-table uk-table-striped'><tr><td>ID</td><td>ID User</td><td> nom & prenom </td><td>type congé</td><td>de </td><td>à</td><td>commentaire</td><td>répondre</td>";
												while($query2=mysqli_fetch_array($result))
												{
												echo "<tr><td>".$query2['idDemandConge']."</td>";
												echo "<td>".$query2['idUser']."</td>";
												echo "<td>".$query2['nomUser'].' '.$query2['prenomUser']."</td>";
												echo "<td>".$query2['typeConge']."</td>";
												echo "<td>".$query2['dateDebut']."</td>";
												echo "<td>".$query2['dateFin']."</td>";
												echo "<td>".$query2['causeConge']."</td>";
												
												
												echo "<td><a href='repondreConge.php?idDemandConge=".$query2['idDemandConge']."'><span  class='btn btn-primary'>répondre</span></a></td>";
