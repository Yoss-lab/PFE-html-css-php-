...
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			if(isset($_GET['idReclam']))
			{
			$idReclam=$_GET['idReclam'];
			if(isset($_POST['submit']))
			{
				...
				if($query3)
				{
					...
					header("Location:http://localhost/leoni/afficheAllReclamation.php");
			...
			$query1=mysqli_query($conn,"select * from reclamation where idReclam='$idReclam'");
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <label class="control-label" for="basicinput">Reclamation</label>
					 
					 
							<textarea  name="commentaire"
									  rows="10" cols="33"  id="basicinput"class="span8" disabled="disabled">
							<?php echo $query2['commentaire']; ?>
							</textarea>
			...
			<div class="control-group">
				<div class="controls">
					 <button class="btn" type="submit" name="submit">marqué lu</button>
				</div>
			</div>
