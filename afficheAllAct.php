                            ...
                            <div class="module-option clearfix">
                                ...
                                <div class="input-append pull-left">
								 ...
								 <div class="input-append pull-right">
									...
									<input type="button" class="btn"  onclick=window.location.href='ajoutAct.php';  value="Puplier">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">-->
									   ...
									   <?php
												...
												echo "<table class='uk-table uk-table-striped'><ol><tr><td>ID</td><td>date</td><td>publication</td><td>image</td><td></td></tr>";
												while($query2=mysqli_fetch_array($resultact))
												{
													//echo"<tr><td></td>";
													
												echo "<tr><td>".$query2['id_act']."</td>";
												echo "<td>".$query2['dat']."</td>";
												echo "<td>".$query2['image_text']."</td>";
												
												echo "<td><img src='images/".$query2['image']."' style='width:10%' ></td>";
												
												//echo "<td>".$query2['image']."</td>";
												
												
												/*echo "<td><a href='editAct.php?id_act=".$query2['id_act']."'><span  class='btn btn-primary'>modifier</span></a></td>";*/
												
												echo "<td><a href='deleteAct.php?id_act=".$query2['id_act']."'><span  class='btn btn-danger'>supprimer</span></a></td></tr>";
