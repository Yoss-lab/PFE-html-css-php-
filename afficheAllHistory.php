                        ...
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
								...
								<div class="input-append pull-right">
									...
									<input type="button" class="btn"  onclick=window.location.href='ajoutHistorique.php';  value="AJOUTER HISTORIQUE">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">-->
									   ...
									   <?php
												...
												echo "<table class='uk-table uk-table-striped'><tr><td>ID</td><td> Année </td><td> Description </td><td>image</td><td></td>";
												while($query2=mysqli_fetch_array($result))
												{
												echo "<tr><td>".$query2['id_hist']."</td>";
												echo "<td>".$query2['annee_hist']."</td>";
												echo "<td>".$query2['text_hist']."</td>";
												echo "<td><img src='images/".$query2['image_hist']."' style='width:10%' ></td>";
												
												
												echo "<td><a href='editHistorique.php?id_hist=".$query2['id_hist']."'><span  class='btn btn-primary'>MODIFIER</span></a></td></tr>";
