...
// Initialize message variable
  ...
  if (isset($_POST['upload'])) {
  	// Get image name
  	$image_hist = $_FILES['image_hist']['name'];
  	// Get text
	$annee_hist = mysqli_real_escape_string($conn, $_POST['annee_hist']);
  	$text_hist = mysqli_real_escape_string($conn, $_POST['text_hist']);
  	

  	// image file directory
  	$target = "images/".basename($image_hist);

  	$sql = "INSERT INTO historique (annee_hist,text_hist,image_hist) VALUES ('$annee_hist', '$text_hist','$image_hist')";
  	// execute query
  	mysqli_query($conn, $sql);

  	if (move_uploaded_file($_FILES['image_hist']['tmp_name'], $target)) {
  		//$msg = "Image uploaded successfully";
		header("Location:http://localhost/leoni/afficheAllHistory.php");
  	}else{
		header("Location:http://localhost/leoni/afficheAllHistory.php");
  	}
  }
...
/*
			...
			*/
			?>
			 ...
			 <form method="post" action="ajoutHistorique.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
					
					
				   <div class="control-group">
						 <label class="control-label" for="basicinput">Année</label>
					
						<input class="uk-input" class="span8" type="text" placeholder="aaaa" name="annee_hist"  id="basicinput">
					</div>
					 <div class="control-group">
					 ...
					 <input type="hidden" name="size" value="1000000" class="uk-input" class="span8">
						...
						<label class="control-label" for="basicinput">Image</label>
						  <input type="file" name="image_hist" class="uk-input" class="span8">
						</div>
						<div class="control-group">
