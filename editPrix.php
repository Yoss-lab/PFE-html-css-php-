	...
	<div class="wrapper">
		<div class="container">
			...
			if(isset($_POST['submit']))
			{
				...
				//$image_prix = $_POST['image_prix'];
				

			$query3=mysqli_query($conn,"UPDATE prix SET title_prix = '$title_prix',subtitle_prix = '$subtitle_prix',text_prix = '$text_prix' WHERE id_prix = '$id'");
			if($query3)
			{
			...
			$query1=mysqli_query($conn,"select * from prix where id_prix='$id'");
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						...
						<input class="uk-input" type="text"  name="title_prix"  id="basicinput"class="span8" 
						value="<?php echo $query2['title_prix']; ?>">
					</div>
					 <div class="control-group">
						 <label class="control-label" for="basicinput">Sous Titre</label>
						<input class="uk-input" type="text"  name="subtitle_prix"  id="basicinput"class="span8" 
						value="<?php echo $query2['subtitle_prix']; ?>">
					</div>
					...
					<!--<div class="control-group">
					 ...
					 <div class="control-group">
						 ...
						 <textarea class="uk-input" type="text"  name="text_prix"  id="basicinput"class="span8">
								<?php echo $query2['text_prix']; ?>
						</textarea>
					</div>
