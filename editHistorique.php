	...
	<div class="wrapper">
		<div class="container">
			...
			if(isset($_POST['submit']))
			{
				...
				$annee = $_POST['annee_hist'];
				$description = $_POST['text_hist'];
				$image = $_POST['image_hist'];
				

			$query3=mysqli_query($conn,"UPDATE historique SET annee_hist = '$annee',text_hist = '$description', image_hist = '$image' WHERE id_hist = '$id'");
			if($query3)
			{
			...
			$query1=mysqli_query($conn,"select * from historique where id_hist='$id'");
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						...
						<input class="uk-input" type="text"  name="annee_hist"  id="basicinput"class="span8" 
						value="<?php echo $query2['annee_hist']; ?>">
					</div>
					 ...
					 <!--<div class="control-group">
						 ...
						 <?php
							...
							//echo "<img src='images/".$query2['image_hist']."' style='width:10%' >";
						?>
					</div>-->
					...
					<div class="control-group">
					 ...
					 <div class="control-group">
						 ...
						 <textarea class="uk-input" type="text"  name="text_hist"  id="basicinput"class="span8">
								<?php echo $query2['text_hist']; ?>
						</textarea>
					</div>
