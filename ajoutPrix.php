...
// Initialize message variable
  ...
  if (isset($_POST['upload'])) {
  	...
  	// Get text
	$title_prix = mysqli_real_escape_string($conn, $_POST['title_prix']);
	$subtitle_prix = mysqli_real_escape_string($conn, $_POST['subtitle_prix']);
  	$text_prix = mysqli_real_escape_string($conn, $_POST['text_prix']);
  	

  	// image file directory
  	$target = "images/".basename($image_prix);

  	$sql = "INSERT INTO prix (title_prix,subtitle_prix,text_prix,image_prix) VALUES ('$title_prix','$subtitle_prix', '$text_prix','$image_prix')";
  	// execute query
  	mysqli_query($conn, $sql);

  	if (move_uploaded_file($_FILES['image_prix']['tmp_name'], $target)) {
...
/*
			...
			*/
			?>
			 ...
			 <form method="post" action="ajoutPrix.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
					
					
				   <div class="control-group">
						 <label class="control-label" for="basicinput">Titre</label>
					
						<input class="uk-input" class="span8" type="text"  name="title_prix"  id="basicinput">
					</div>
					<div class="control-group">
						 <label class="control-label" for="basicinput">Sous titre</label>
					
						<input class="uk-input" class="span8" type="text"  name="subtitle_prix"  id="basicinput">
					</div>
						...
						<div class="control-group">
						 <label class="control-label" for="basicinput">Description</label>
						  <textarea 
							...
							placeholder="Say something about this price..."></textarea>
						</div>
						<div class="control-group">
					 ...
					 <input type="hidden" name="size" value="1000000" class="uk-input" class="span8">
						...
						<label class="control-label" for="basicinput">Image</label>
						  <input type="file" name="image_prix" class="uk-input" class="span8">
						</div>
						<div class="control-group">
				<div class="controls">
