...
// Initialize message variable
  ...
  if (isset($_POST['upload'])) {
  	...
  	$sql = "INSERT INTO actualite (image, image_text,dat) VALUES ('$image', '$image_text',CURDATE())";
  	// execute query
...
/*
			...
			*/
			?>
			 ...
			 <form method="post" action="ajoutAct.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
					
					
				   <div class="control-group">
						 <!--<label class="control-label" for="basicinput">publication</label>-->
					
						<!--<input class="uk-input" type="text" placeholder="publication" name="publication"  id="basicinput"class="span8">-->
					</div>
					 <div class="control-group">
					 ...
					 <input type="hidden" name="size" value="1000000">
						...
						<div>
						  <textarea 
							...
							rows="4" 
							name="image_text" 
							placeholder="Ecrire quelque chose..."></textarea>
						</div>
						<div>
