...
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			$query3=mysqli_query($conn,"UPDATE evenement SET title_event = '$title_event',text_event = '$text_event' WHERE id_event = '$id'");
			if($query3)
			{
			...
			$query1=mysqli_query($conn,"select * from evenement where id_event='$id'");
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						...
						<input class="uk-input" type="text"  name="title_event"  id="basicinput"class="span8" 
						value="<?php echo $query2['title_event']; ?>">
					</div>
					...
					<!--<div class="control-group">
					 ...
					 <div class="control-group">
						 ...
						 <textarea class="uk-input" type="text"  name="text_event"  id="basicinput"class="span8">
								<?php echo $query2['text_event']; ?>
						</textarea>
					</div>
