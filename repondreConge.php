		...
		<div class="container">
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						 <label class="control-label" for="basicinput">Type congé</label>
					...
					<div class="control-group">
						 <label class="control-label" for="basicinput">à</label>
					...
					<br/>
					 ...
					 <div class="control-group">
					 <label class="control-label" for="basicinput">Réponse</label>
					    <input class="uk-input" type="text" name="statut"  id="basicinput"class="span8" placeholder="Accepté / Refusé"
						 >
