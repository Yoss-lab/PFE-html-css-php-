                        ...
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
								...
								<div class="input-append pull-right">
									...
									<input type="button" class="btn"  onclick=window.location.href='ajoutEmploi.php';  value="AJOUTER EMPLOI">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">-->
									   ...
									   <?php
												...
												echo "<table class='uk-table uk-table-striped'><tr><td>ID</td><td>date</td><td> Titre </td><td> Description </td><td> Annonce par </td><td>image</td><td></td><td></td>";
												while($query2=mysqli_fetch_array($result))
												{
												echo "<tr><td>".$query2['id_emploi']."</td>";
												echo "<td>".$query2['dat']."</td>";
												echo "<td>".$query2['title_emploi']."</td>";
												echo "<td>".$query2['desc_emploi']."</td>";
												echo "<td>".$query2['annonce_de']."</td>";
												echo "<td><img src='images/".$query2['image_emploi']."' style='width:10%' ></td>";
												//echo"<td></td>";
												echo "<td><a href='deleteEmploi.php?id_emploi=".$query2['id_emploi']."'><span  class='btn btn-danger'>supprimer</span></a></td>";

												echo "<td><a href='editEmploi.php?id_emploi=".$query2['id_emploi']."'><span  class='btn btn-primary'>MODIFIER</span></a></td></tr>";
