...
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			$query3=mysqli_query($conn,"UPDATE actualite SET image = '$image',image_text = '$text' WHERE id_act = '$id'");
			if($query3)
			{
			...
			$query1=mysqli_query($conn,"select * from actualite where id_act='$id'");
			...
			?>
			 ...
			 <form method="post" action="" enctype="multipart/form-data" class="form-horizontal row-fluid">
					 ...
					 <div class="control-group">
						...
						<textarea class="uk-input" name="image_text"  id="basicinput"class="span8" rows="10" cols="33"  >
						<?php echo $query2['image_text']; ?>
						</textarea>
				   ...
				   <div class="control-group">
						...
						<?php echo "<img src='images/".$query2['image']."' style='width:20%' >"; ?>
