                        ...
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
								...
								<div class="input-append pull-right">
									...
									<input type="button" class="btn"  onclick=window.location.href='ajoutAction.php';  value="AJOUTER ACTION">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">-->
									   ...
									   <?php
												...
												echo "<table class='uk-table uk-table-striped'><tr><td>ID</td><td> Titre </td><td> Description </td><td>image</td><td></td>";
												while($query2=mysqli_fetch_array($result))
												{
												echo "<tr><td>".$query2['id_event']."</td>";
												echo "<td>".$query2['title_event']."</td>";
												echo "<td>".$query2['text_event']."</td>";
												echo "<td><img src='images/".$query2['image_event']."' style='width:10%' ></td>";
												//echo"<td></td>";
												echo "<td><a href='deleteAction.php?id_event=".$query2['id_event']."'><span  class='btn btn-danger'>supprimer</span></a></td>";

												echo "<td><a href='editAction.php?id_event=".$query2['id_event']."'><span  class='btn btn-primary'>MODIFIER</span></a></td></tr>";
