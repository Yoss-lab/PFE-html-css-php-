                        ...
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
								...
								<div class="input-append pull-right">
									...
									<input type="button" class="btn"  onclick=window.location.href='ajoutPrix.php';  value="AJOUTER prix">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">-->
									   ...
									   <?php
												...
												echo "<table class='uk-table uk-table-striped'><tr><td>ID</td><td> titre </td><td> sous titre </td><td> Description </td><td>image</td><td></td><td></td>";
												while($query2=mysqli_fetch_array($result))
												{
												echo "<tr><td>".$query2['id_prix']."</td>";
												echo "<td>".$query2['title_prix']."</td>";
												echo "<td>".$query2['subtitle_prix']."</td>";
												echo "<td>".$query2['text_prix']."</td>";
												echo "<td><img src='images/".$query2['image_prix']."' style='width:10%' ></td>";
												
												echo "<td><a href='deletePrix.php?id_prix=".$query2['id_prix']."'><span  class='btn btn-danger'>supprimer</span></a></td>";

												echo "<td><a href='editPrix.php?id_prix=".$query2['id_prix']."'><span  class='btn btn-primary'>MODIFIER</span></a></td></tr>";
